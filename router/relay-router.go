...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.SessionRecorderCapture(), middleware.Distribute())
	{
	...
	}
	{
		...
		httpRouter.Use(middleware.SessionRecorderCapture(), middleware.Distribute())
	...
	relayGeminiRouter.Use(middleware.SessionRecorderCapture(), middleware.Distribute())
	{
